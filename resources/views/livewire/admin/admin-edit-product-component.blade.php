       ...
       <div class="min-height-200px">
         <div class="page-header">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                ...
                <form method="POST" action="" wire:submit.prevent="editProduct" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label class="col-form-label">Image</label>
                        <div>
                            <input class="form-control" type="file" name="newimage" wire:model="newimage">
                            @error('newimage') <span class="text-danger">{{$message}}</span> @enderror
                            @if($newimage)
                             <br>
                             <img src="{{$newimage->temporaryUrl()}}" width="120">
                            @else
                            <img src="{{asset('website/imgs/shop/product')}}/{{$image}}" width="120">
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input class="form-control" type="file" name="newimages" wire:model="newimages" multiple>
                            @if($newimages)
                              <br>
