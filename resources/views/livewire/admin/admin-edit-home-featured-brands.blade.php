       ...
       <div class="min-height-200px">
         <div class="page-header">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                ...
                <form method="POST" action="" wire:submit.prevent="editFeaturedBrands" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            ...
                            @else
                            <br>
                            <img src="{{asset('website/imgs/featured_brands')}}/{{$image}}" width="250">
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input type="submit" value="Update Brands" class="btn btn-primary">
                        </div>
                    </div>
                </form>
            </div>
